...
public class WwiseSetupWizard : WwiseSetupWindow 
{
    ...
    private static GUIStyle WelcomeStyle = null;
    private static GUIStyle HelpStyle = null;
	private static WwiseSetupWizard windowInstance = null;
	private static string m_newIntegrationVersion = string.Empty;

    private const uint SETUP_WINDOW_WIDTH = 875;
...
For more information on a particular setting, hover your mouse over it.", 
    ...
    public static void PackageDemo()
    {
        ...
        AssetDatabase.ExportPackage(dirsToExport, destDir, ExportPackageOptions.Recurse | ExportPackageOptions.IncludeLibraryAssets | ExportPackageOptions.IncludeDependencies);
    }
