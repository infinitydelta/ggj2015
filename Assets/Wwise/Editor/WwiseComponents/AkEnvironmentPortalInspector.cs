...
public class AkEnvironmentPortalInspector : Editor
{
	...
	public static void CreatePortal()
	{
		...
		portal.collider.isTrigger = true;

		portal.rigidbody.useGravity = false;
		portal.rigidbody.isKinematic = true;
		portal.rigidbody.collisionDetectionMode = CollisionDetectionMode.Continuous;
