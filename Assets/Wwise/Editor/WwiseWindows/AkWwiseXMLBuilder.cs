...
public class AkWwiseXMLBuilder
{
    public static void Populate()
    {
        ...
        string WwiseProjectFullPath = AkUtilities.GetFullPath(Application.dataPath, WwiseSetupWizard.Settings.WwiseProjectPath);
        string FullSoundbankPath = AkUtilities.GetWwiseSoundBankDestinationFolder(platformSubDir, WwiseProjectFullPath);
        FullSoundbankPath = AkUtilities.GetFullPath(Path.GetDirectoryName(WwiseProjectFullPath), FullSoundbankPath);
